class TestData:
    test_data_user1 = ['Коралл', 'Марудов', 'Морская, 77', 'Кропоткинская', '+79173331122', '24.04.2025',
                 'Хочу коралловый скутер!']
    test_data_user2 = ['Алмаз', 'Индиго', 'Останкино', 'ВДНХ', '+79001234567', '25.04.2025',
                 'Сейчас я вам тут почистию']
