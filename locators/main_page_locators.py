...
class MainPageLocators:
    ...
    main_header = (By.XPATH, '//div[contains(@class, "Home_Header__iJKdX")]') #Самокат на пару дней!
    # Раздел "Вопросы о важном"
    faq_section = (By.XPATH, '//div[contains(@class, "Home_FAQ")]')
    faq_questions_items = { # локаторы под каждый вопрос
    ...
    faq_answers_items = { #локаторы для каждого ответа
